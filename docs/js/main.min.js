...
/* harmony import */ var _modules_player_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/player.js */ "./js/modules/player.js");
/* harmony import */ var _modules_touch_coach_slide_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/touch-coach-slide.js */ "./js/modules/touch-coach-slide.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_nojs__WEBPACK_IMPORTED_MODULE_1__["deleteNoJs"])();
  Object(_modules_tab_js__WEBPACK_IMPORTED_MODULE_2__["createTab"])();
  Object(_modules_slider_js__WEBPACK_IMPORTED_MODULE_3__["createSliderCoaches"])();
  Object(_modules_touch_coach_slide_js__WEBPACK_IMPORTED_MODULE_5__["chooseSlideByTouch"])();
  Object(_modules_carousel__WEBPACK_IMPORTED_MODULE_6__["createCarouselReviews"])();
  Object(_modules_player_js__WEBPACK_IMPORTED_MODULE_4__["createPlayer"])();
  Object(_modules_form_js__WEBPACK_IMPORTED_MODULE_7__["submitFeedBackForm"])();
  // Modules
  // ---------------------------------
...
/*!********************************!*\
  !*** ./js/modules/carousel.js ***!
  \********************************/
/*! exports provided: createCarouselReviews */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createCarouselReviews", function() { return createCarouselReviews; });
...
var createCarouselReviews = function createCarouselReviews() {
...
/* harmony import */ var _local_storage_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./local-storage.js */ "./js/modules/local-storage.js");
/* harmony import */ var _result_modal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./result-modal.js */ "./js/modules/result-modal.js");



Object(_validate_form_js__WEBPACK_IMPORTED_MODULE_0__["validateForm"])();
Object(_local_storage_js__WEBPACK_IMPORTED_MODULE_1__["showStorage"])();
var sendFormData = function sendFormData(data) {
  fetch('https://echo.htmlacademy.ru/', {
    ...
    if (response.ok) {
      Object(_local_storage_js__WEBPACK_IMPORTED_MODULE_1__["clearLocalStorage"])();
      Object(_result_modal_js__WEBPACK_IMPORTED_MODULE_2__["getSuccessMessage"])();
    }
  });
};
...
var submitFeedBackForm = function submitFeedBackForm() {
  _local_storage_js__WEBPACK_IMPORTED_MODULE_1__["forms"].forEach(function (form) {
...
var videoOverlay = videoContainer.querySelector('.video__overlay');
var videoLink = videoContainer.querySelector('.video__link');
var createVideoPlaybackSetting = function createVideoPlaybackSetting() {
...
var createIframe = function createIframe(id, container) {
  ...
  item.setAttribute('src', "https://www.youtube.com/embed/".concat(id, "?autoplay=1&enablejsapi=0"));
...
var getSuccessMessage = function getSuccessMessage() {
  var successMessage = document.querySelector('.modal');
  successMessage.classList.remove('visually-hidden');
  document.body.classList.add('scroll-lock');
  var successButton = successMessage.querySelector('.modal__button');
...
/*!******************************!*\
  !*** ./js/modules/slider.js ***!
  \******************************/
/*! exports provided: createSliderCoaches */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createSliderCoaches", function() { return createSliderCoaches; });
/* harmony import */ var _vendor_swiper_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/swiper.js */ "./js/vendor/swiper.js");
/* global Swiper */


var createSliderCoaches = function createSliderCoaches() {
  ...
  var sliderItemsArray = Array.from(swiper.slides);
  var firstDublicateItems = [];
  var findFirstDublicateItems = function findFirstDublicateItems() {
    sliderItemsArray.some(function (element) {
  ...
  var setTabOnTheFirstCard = function setTabOnTheFirstCard() {
    findFirstDublicateItems();
    firstDublicateItems.forEach(function (item) {
...
/*!***************************!*\
  !*** ./js/modules/tab.js ***!
  \***************************/
/*! exports provided: createTab */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createTab", function() { return createTab; });
var buttonTabs = document.querySelectorAll('.tabs__button-item');
var contentTabs = document.querySelectorAll('.tabs__content-list');
var DESCTOP_WIDTH = '(min-width:1200px)';
var breakpoint = window.matchMedia(DESCTOP_WIDTH);
var breakpointChecker = function breakpointChecker(item) {
  if (breakpoint.matches) {
...
var hideNotFirstContent = function hideNotFirstContent() {
  contentTabs.forEach(function (item, index) {
    if (index > 0) {
...
hideNotFirstContent();
var switchСontentTab = function switchСontentTab(indexButton) {
  contentTabs.forEach(function (item, indexContent) {
...
var createTab = function createTab() {
  buttonTabs.forEach(function (button, indexButton) {
    button.addEventListener('click', function () {
      buttonTabs.forEach(function (elem) {
...
/***/ "./js/modules/touch-coach-slide.js":
/*!*****************************************!*\
  !*** ./js/modules/touch-coach-slide.js ***!
  \*****************************************/
/*! exports provided: chooseSlideByTouch */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "chooseSlideByTouch", function() { return chooseSlideByTouch; });
var slideList = document.querySelector('.slide__list');

// Except Destop Size
var MAX_WIDTH = '(max-width:1199px)';
var breakpoint = window.matchMedia(MAX_WIDTH);
var onSlideClick = function onSlideClick(evt) {
  var slide = evt.target.closest('.slide__item');
  slide.classList.toggle('is-open');
};
var chooseSlideByTouch = function chooseSlideByTouch() {
  if (breakpoint.matches) {
...
var MASK_PHONE_FORMAT = '89';
var formattedInputValue;
var showValidateTitle = function showValidateTitle(evt, title) {
...
var onNameValidateInput = function onNameValidateInput(evt) {
  var inputValueArray = Array.from(evt.target.value);
  var arr = [];
...
var onPhoneNumberChange = function onPhoneNumberChange(evt) {
